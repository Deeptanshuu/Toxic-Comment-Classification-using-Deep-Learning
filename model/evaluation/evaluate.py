                ...
                if valid_thresholds:
                    ...
                    best_threshold = max(
                        ...
                        key=lambda x: (
                            ...
                            x['f1'] * 0.2 +         # Consider Hamming accuracy
                            x['hamming_accuracy'] * 0.1
                        )
                    )
